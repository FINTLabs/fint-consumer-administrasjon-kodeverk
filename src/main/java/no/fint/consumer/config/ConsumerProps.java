...
public class ConsumerProps {
	...
	public static final String CACHE_INITIALDELAY_TIMERPERUKEKODE = "${fint.consumer.cache.initialDelay.timerperukekode:130000}";
	public static final String CACHE_FIXEDRATE_TIMERPERUKEKODE = "${fint.consumer.cache.fixedRate.timerperukekode:900000}";
