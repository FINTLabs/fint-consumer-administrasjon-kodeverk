...
public class StillingskodeController {
    ...
    @GetMapping
    public ResponseEntity getStillingskode(@RequestHeader(value = HeaderConstants.ORG_ID, defaultValue = Constants.DEFAULT_HEADER_ORGID) String orgId,
    ...
    public ResponseEntity getStillingskode(@PathVariable String id,
        ...
        Optional<FintResource<Stillingskode>> stillingskode = cacheService.getStillingskode(orgId, id);
