...
public class AnleggController {
    ...
    public AnleggResources getAnlegg(
        ...
        List<AnleggResource> anlegg;
        if (sinceTimeStamp == null) {
            anlegg = cacheService.getAll(orgId);
        } else {
            anlegg = cacheService.getAll(orgId, sinceTimeStamp);
        }

        fintAuditService.audit(event, Status.CACHE_RESPONSE, Status.SENT_TO_CLIENT);

        return linker.toResources(anlegg);
    }
    ...
    public AnleggResource getAnleggBySystemId(
        ...
        if (cacheService != null) {
            ...
            return linker.toResource(anlegg);
        }    
    }
